  ...
  <div class="max-w-4xl mx-auto">
      ...
      <UiCardContent class="p-6">
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center gap-6">
            ...
            <div class="space-y-2">
              <UiButton variant="outline" size="sm" @click="uploadImage">
          ...
          <form @submit.prevent="saveProfile" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="space-y-2">
                <UiLabel for="phone">Phone Number</UiLabel>
                <UiInput 
                  id="phone" 
              ...
              <div class="space-y-2">
                <UiLabel for="organization">Organization Name</UiLabel>
                <UiInput 
                  id="organization" 
            ...
            <div class="flex items-center justify-between p-4 border rounded-lg bg-gray-50">
              ...
              <UiSwitch v-model="accountData.isOrganization" />
            </div>
            ...
            <div class="flex justify-end gap-4">
              ...
              <UiButton type="submit" :disabled="isSaving" class="bg-primary hover:bg-primary/90 text-white">
    ...
    <UiCard>
      <UiCardContent class="p-6">
        ...
        <div class="space-y-4">
          <div class="space-y-2">
            <UiLabel for="office-location">Office Address</UiLabel>
            <Textarea 
              id="office-location" 
              :rows="3"
          ...
          <div class="space-y-2">
            <UiLabel for="map-link">Google Maps Link</UiLabel>
            <UiInput 
              id="map-link" 
              type="url" 
      ...
      <UiCardContent class="p-6">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between p-4 border rounded-lg">
            ...
            <UiSwitch v-model="accountData.emailNotifications" />
          </div>
          ...
          <div class="flex items-center justify-between p-4 border rounded-lg">
            ...
            <UiSwitch v-model="accountData.smsNotifications" />
          </div>
        </div>
      </UiCardContent>
    </UiCard>
...
function uploadImage() {
  ...
  input.onchange = (e) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        accountData.value.profileImage = e.target?.result as string
      }
