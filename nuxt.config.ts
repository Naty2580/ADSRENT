  ...
  app: {
    head: { 
      ...
      link: [
        ...
        { rel: 'preload', as: 'style', href: 'https://fonts.googleapis.com/css2?family=DM+Sans:wght@700&family=Public+Sans:wght@400;500;600&display=swap' },
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=DM+Sans:wght@700&family=Public+Sans:wght@400;500;600&display=swap' },
      ],
      meta: [
        { name: 'description', content: 'The easiest way to find your next home for sale or rent in Ethiopia.' }
      ]
    },
  },
  // i18n: {
